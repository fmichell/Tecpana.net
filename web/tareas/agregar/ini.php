...
<html lang="es">
<head>
    <title>Agregar Tarea - <?php echo SISTEMA_NOMBRE ?></title>
    ...
    <div id="MainWrapper">
        ...
        <section id="Content">
            ...
            <section id="Workspace" class="colum formulario">
                <form method="post" action="tareas_form.html" name="frmAgregarTarea" id="frmAgregarTarea" class="frmProyecto">
                    <!--Workspace Header begins-->
                    <div class="workspaceHeader interior10">
                        <input type="text" class="bigText ancho98di" placeholder="Nombre de la tarea" id="nombre" /><br />
                    ...
                    <div class="workspaceArea interior10">
                        <div class="linea10"></div>
                        <dl class="vertical">
                            <dt><label for="descripcion">Descripción de la tarea:</label></dt>
                            <dd><textarea name="descripcion" id="descripcion" rows="100" cols="10" class="ancho98di"></textarea></dd>
                        </dl>
                        <div class="linea10"></div>
                        <a class="boton_gris floatLeft btnForm" href="#">Agregar Tarea</a>
