...
<html lang="es">
<head>
    <title>Notas de la tarea - <?php echo SISTEMA_NOMBRE ?></title>
        ...
        <section id="Content" class="wToolbar">
            ...
            <section id="Workspace" class="colum">
                ...
                <div class="workspaceToolbar">
                    <div class="opciones">
                        <ul>
                            <li><a href="/tareas/<?php echo $tarea_id ?>/info">Detalles de la tarea</a></li>
                            <li><a href="/tareas/<?php echo $tarea_id ?>/comentarios" class="activo">Comentarios</a></li>
                        </ul>
                    </div>
                </div>
